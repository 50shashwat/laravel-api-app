...
@section('content')
    <div class="row">
        <div class="col-sm-12">
            <section class="panel">
                <header class="panel-heading ">Create new contact for user</header>
            </section>
            <div class="panel-body">
                <form role="form" action="{{ route('admin.users.createContact') }}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group @if($errors->has('user_id')) has-error @endif">
                        ...
                        <select class="form-control select2" name="user_id"
                                ...
                                v-validate:user_id="['required']" placeholder="SELECT USERS"
                        >
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        for (i = 0; i < data.length; i++) {
                            $('#contact_id').append('<option value="' + data[i].id  + '">' + data[i].last_name + "   " + data[i].first_name + '</option>');
                        }
                    }
                })
            }
