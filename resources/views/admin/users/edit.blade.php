    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="panel-body">
                <form role="form" action="{{ route('admin.users.edit') }}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group @if($errors->has('url')) has-error @endif">
                        ...
                        <input type="text" class="form-control" name="url" value="{{ $user->url }}" id="url" placeholder="Enter company website url">
                        @if($errors->has('url'))
                    ...
                    <div class="form-group @if($errors->has('telephone')) has-error @endif">
                        ...
                        <input type="text" class="form-control" name="telephone" value="{{ $user->telephone}}" id="telephone" placeholder="Enter telephone">
                    ...
                    <div class="form-group @if($errors->has('biography')) has-error @endif">
                        ...
                        <textarea name="biography" id="biography" class="form-control" placeholder="Enter biography">{{ $user->biography }}</textarea>
                    ...
                    <div  id="datetimepicker"  class="form-group @if($errors->has('expired_at')) has-error @endif">
                        <label for="expired_at">Expired date</label>
                            <input class="form-control" name="expired_at" id="expired_at" value="{{ $user['y_m_d_expired_at'] }}" type="text"></input>
                        <span class="add-on">
                    ...
                    <div class="form-group @if($errors->has('avatar')) has-error @endif">
                        ...
                        <input id="avatar" class="file" name="avatar" value="/{{$user->avatar}}" type="file" multiple=true>
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            @if($user->avatar != '')
           $('.file-preview-thumbnails').append('<div class="file-preview-frame" data-fileindex="0">'+
                   '<img src="/{{$user->avatar}}" alt="sss.png" style="width:160px;height:160px;">'+
                    '<div class="file-thumbnail-footer">'+
                    '<div class="file-caption-name" style="width: 172px;">'+'</div></div> </div>');

            $('.file-preview ').css('display','block');
            $('.file-input-new .close').css('display','block');
            @endif
        });
    </script>
@endsection