...
exports.default = {
    ...
    methods: {
        fetchPosts: function fetchPosts() {
            ...
            this.$http.get('/posts/fetch').then(function (response) {
                _this.$set('posts', response.data);
            });
        },
        enable: function enable(post) {
            post.deleted_at = null;
            this.$http.post('/posts/enable/' + post.id, {}).then(function (response) {
                console.debug(response);
            });
        },
        disable: function disable(post) {
            post.deleted_at = 1;
            this.$http.post('/posts/disable/' + post.id, {}).then(function (response) {
                console.debug(response);
            });
        },
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-28aa70b6", module.exports)
  } else {
    hotAPI.update("_v-28aa70b6", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":4,"vue-hot-reload-api":2,"vueify/lib/insert-css":5}],7:[function(require,module,exports){
'use strict';

var _index = require('./components/posts/index.vue');
...
new _vue2.default({
    ...
    components: {
        Posts: _index2.default
    }
});

},{"./components/posts/index.vue":6,"vue":4,"vue-resource":3}]},{},[7]);
