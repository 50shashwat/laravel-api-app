    ...
    methods: {
        load: function load() {
            ...
            this.fetchData().then(function (response) {
                return _this.render(response.data);
            });
        },
        ...
        render: function render(data) {
            this.chart = new _chart2.default(this.$els.canvas.getContext('2d')).Line({
...
},{"chart.js":1,"vue":4}],6:[function(require,module,exports){
'use strict';
...
exports.default = _Graph2.default.extend({
    ...
    methods: {
        fetchData: function fetchData() {
            return this.$http.post(this.url, { range: this.range });
        }
    }
});
...
},{"./Graph":5}],8:[function(require,module,exports){
'use strict';
...
var _LoginsGraph = require('./components/LoginsGraph');

var _LoginsGraph2 = _interopRequireDefault(_LoginsGraph);

var _RegistrationsGraph = require('./components/RegistrationsGraph');

var _RegistrationsGraph2 = _interopRequireDefault(_RegistrationsGraph);
...
new _vue2.default({
    ...
    components: { LoginsGraph: _LoginsGraph2.default, RegistrationsGraph: _RegistrationsGraph2.default }
});

},{"./components/LoginsGraph":6,"./components/RegistrationsGraph":7,"vue":4,"vue-resource":3}]},{},[8]);
